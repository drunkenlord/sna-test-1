...
if (process.platform.startsWith("win")) {
	...
	//nodeexe = '/snap/hapi-combined12/current/hapi-server-v1.0.10/server.js';
	nodeexe =  '"' + process.execPath + '" /snap/hapi-combined13/current/hapi-server-v1.0.10/server.js';
	metadir =  __dirname + '\\..\\metadata';	
} else {
	//nodeexe = "'" + process.execPath + "' server.js";
	//nodeexe = '/snap/hapi-combined12/current/hapi-server-v1.0.10/bin/node /snap/hapi-combined12/current/hapi-server-v1.0.10/server.js';
	nodeexe =  '"' + process.execPath + '" /snap/hapi-combined13/current/hapi-server-v1.0.10/server.js';
	metadir = __dirname + '/../metadata';
}
...
let server_args = ' --logdir="/home/parallels/hapi_logs" --metadata_dir="/home/parallels/hapi_metadata"';
if (argv.https) {
	server_args = "--https";
	if (process.platform.startsWith("win")) {
